...
def preprocess_surface(surface_coords, surface_tris, hemisphere):
    ...
    sphere_coords, sphere_tris, orig_coords, orig_tris = spherical_projection_40962(
        (surface_coords, surface_tris), hemisphere
    )
...
def compute_template_projection(template_mesh, template_name, hemisphere):
    """
